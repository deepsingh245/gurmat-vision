    ...
    <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
      ...
      <Section title={t('policy.whatSupport')} icon={CheckCircle2}>
        <ul className="space-y-1 divide-y divide-gray-50">
          ...
          <Rule allowed={true}>Gurdwara architecture, landscapes, and natural scenes</Rule>
          <Rule allowed={true}>Gurpurab and festival celebration posters and reels</Rule>
          <Rule allowed={true}>Community life, Langar, Seva, and devotional artwork</Rule>
          <Rule allowed={true}>Inspirational cards for morning Ardas, Simran, and daily reflection</Rule>
          <Rule allowed={true}>Content in Punjabi and English that respectfully shares Sikh wisdom</Rule>
        </ul>
      </Section>
