  ...
  return (
    <div className="max-w-xl mx-auto text-center space-y-8 animate-fade-in-up">
      <div className="bg-gradient-to-br from-navy-900 to-navy-800 rounded-3xl p-10 text-white shadow-xl relative overflow-hidden">
        ...
        <p className="text-navy-200 mb-8 relative z-10">Speak naturally in English or Punjabi.<br/>Try "Create 5 peace quotes" or "Make a hukumnama status"</p>
      ...
      {result && (
        <div className="bg-white text-left p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="mt-4 flex gap-2">
            <Button className="w-full" onClick={() => alert("Action execution would route to the specific tab with this prompt.")}>
              Execute Action
            </Button>
          </div>
        </div>
